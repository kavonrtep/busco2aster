...
- `alignment.smk`: batched retained-locus FASTA export plus batched MAFFT alignment with one thread per locus inside each batch
- `gene_trees.smk`: IQ-TREE 3 directory-mode gene-tree inference plus stable aggregate gene-tree exports
