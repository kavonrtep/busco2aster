...
## Testing Guidelines
Large genome files should not be committed. Use lightweight fixtures and metadata in [`test_data/`](/home/petr/PycharmProjects/get_phylo/test_data) for parser, filtering, reporting, and container-wrapper tests. For workflow changes, require at minimum a Snakemake dry-run, targeted unit tests for parser/filter/report logic, and one small end-to-end smoke test when fixtures exist.
